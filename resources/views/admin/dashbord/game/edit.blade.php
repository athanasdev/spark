                    ...
                    <form method="POST" action="{{ route('admin.game_settings.update', $gameSetting->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control @error('start_time') is-invalid @enderror"
                                ...
                                value="{{ old('start_time', $gameSetting->start_time->setTimezone($adminTimezone)->format('H:i')) }}"
                                required>
                            @error('start_time')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control @error('end_time') is-invalid @enderror"
                                ...
                                value="{{ old('end_time', $gameSetting->end_time->setTimezone($adminTimezone)->format('H:i')) }}"
                                required>
                            @error('end_time')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <select id="type" name="type" class="form-control @error('type') is-invalid @enderror"
                                ...
                                <option value="buy" {{ old('type', $gameSetting->type) == 'buy' ? 'selected' : '' }}>Buy
                                </option>
                                <option value="sell" {{ old('type', $gameSetting->type) == 'sell' ? 'selected' : '' }}>
                                    Sell</option>
                            </select>
                            @error('type')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
