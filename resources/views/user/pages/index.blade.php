...
<!-- Mirrored from crypo-laravel-live.netlify.app/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Feb 2023 05:54:51 GMT -->
<!-- Added by HTTrack -->
        ...
        <div class="row sm-gutters">
            <div class="col-md-3 d-none d-md-block">
                <div class="market-pairs">
                    ...
                    <ul class="nav nav-pills" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#ETH" role="tab"
                                aria-selected="false">ETH</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#NEO" role="tab"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#DAI" role="tab"
            ...
            <div class="col-md-3">
                ...
                <div class="market-history">
                    <ul class="nav nav-pills" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#market-depth" role="tab"
            ...
            <div class="col-md-3">
                <div class="market-news mt15">
                    ...
                    <ul>
                        <li><a href="news-details/index.html">
                                <strong>KCS Pay Fees Feature is Coming Soon</strong>
                                To accelerate the ecosystem construction of KuCoin Share (KCS) and promote the
                                implementation of the KCS
                                application.
            ...
            <div class="col-md-9">
                <div class="market-history market-order mt15">
                    <ul class="nav nav-pills" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#trade-history" role="tab"
